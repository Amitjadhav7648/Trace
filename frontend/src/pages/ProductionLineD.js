...
const response = await axios.post(
  ...
  "http://localhost:5000/api/line-d/create-uid",
  ...
  finishedBatches.map((item) => (
    ...
    >
      ...
      <div className="stations-wrapper">
        ...
        <div className={`station-card line-d-card ${currentStation === 1 ? "active-card" : ""}`}>
...
export default ProductionLineD;